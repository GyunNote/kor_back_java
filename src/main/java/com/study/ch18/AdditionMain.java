...
public class AdditionMain {
    public static void main(String[] args) {
        ...
        //람다식
        //람다식 핵심 조건 -> 인터페이스 안에 딱 하나의 추상메소드만 정의되어 있어야 한다!
        ...
        View view1 = (String viewData) -> {
            System.out.println("화면 출력") ;
        };

        View view2 = (viewData) -> System.out.println("화면 출력");

        //3 매개변수가 1개면 매개변수의 괄호를 생략할 수 있다.
        View view3 = viewData -> System.out.println("화면출력");
